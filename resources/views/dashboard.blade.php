<x-app-layout>
    <div class="bg-gradient-to-tr from-blue-50 via-white to-blue-100 min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            {{-- Flash Message --}}
            @if(session('success'))
                <div class="bg-green-100 border-l-4 border-green-500 text-green-800 px-5 py-4 rounded-md shadow-sm mb-6">
                    ✅ {{ session('success') }}
                </div>
            @endif
            ...
            <div x-data="{ tab: 'overview' }">
                <div class="flex border-b border-blue-300 mb-6 space-x-4">
                    <button @click="tab = 'overview'" class="px-4 py-2 font-semibold text-blue-800 border-b-4" :class="{ 'border-blue-600': tab === 'overview' }">
                        Overview
                    </button>
                    <button @click="tab = 'bookings'" class="px-4 py-2 font-semibold text-blue-800 border-b-4" :class="{ 'border-blue-600': tab === 'bookings' }">
                        Recent Bookings
                    </button>
                    <button @click="tab = 'actions'" class="px-4 py-2 font-semibold text-blue-800 border-b-4" :class="{ 'border-blue-600': tab === 'actions' }">
                        Quick Actions
                    </button>
                </div>
                ...
                <div x-show="tab === 'bookings'" class="mt-6">
                    <div class="bg-white rounded-xl shadow p-6">
                        <h2 class="text-2xl font-semibold text-blue-800 mb-4">📋 Recent Bookings</h2>
                ...
                {{-- Actions Tab --}}
                <div x-show="tab === 'actions'" class="mt-6">
