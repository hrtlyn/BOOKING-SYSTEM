...
use Illuminate\Foundation\Auth\Access\AuthorizesRequests; // ✅ Import for authorize()
use Carbon\Carbon;

class BookingController extends Controller
{
    use AuthorizesRequests; // ✅ Enable authorize() method
    ...
    public function store(Request $request)
    {
        ...
        $bookingDateTime = Carbon::parse($request->booking_date . ' ' . $request->booking_time . ':00');
